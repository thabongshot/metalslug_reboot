...
private:
	...
	std::vector<SDL_Surface*> backgroundFarImages;
	std::vector<SDL_Rect> backgroundFarRects;

	std::vector<SDL_Surface*> backgroundNearImages;
	std::vector<SDL_Rect> backgroundNearRects;

	std::vector<SDL_Surface*> foregroundImages;
	std::vector<SDL_Rect> foregroundRects;
...
public:
	...
	void createPtolemaicSoldier(int x, int y);
